	...
	<div class="container">
		<div class="jumbotron col-sm-9"
				...
				<div class=" col-md-7">
					<form:form id="createForm" method="post"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-2" class="form-control" readonly="true"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-1" class="form-control" readonly="true"
						...
						<div class="form-group">
							...
							<form:input type="text" id="datepicker-3" class="form-control" readonly="true"
			...
			<br> <a href="/Vehicle_Reservation_System/homeAgain"><button
					class="btn btn-primary" style="margin-left: 49%;">
