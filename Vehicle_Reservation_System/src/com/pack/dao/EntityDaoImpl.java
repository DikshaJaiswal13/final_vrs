...
public class EntityDaoImpl implements EntityDao {
	...
	public List<VehicleEntity> searchVehicle(VehicleEntity vehicle) {
		...
		if(vehicle.getServiceDueDate() != null && !vehicle.getServiceDueDate().equals("")){
			if(qwry.endsWith("where"))
				qwry += " serviceDueDate like '___"+String.valueOf(vehicle.getServiceDueDate()+"%'");
			else
				qwry += " and serviceDueDate like '___"+String.valueOf(vehicle.getServiceDueDate()+"%'");
		}
		if(vehicle.getLastServiceDate() != null && !vehicle.getLastServiceDate().equals("")){
			if(qwry.endsWith("where"))
				qwry += " lastServiceDate like '___"+String.valueOf(vehicle.getLastServiceDate()+"%'");
			else
				qwry += " and lastServiceDate like '___"+String.valueOf(vehicle.getLastServiceDate()+"%'");
		}
